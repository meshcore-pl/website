...
W kolejnym wydaniu (v1.15.0) pojawi się nowa koncepcja „domyślnego zakresu” (default scope), zarówno dla węzłów companion, jak i przemienników/room serwerów. Umożliwi to obejmowanie zakresem wiadomości prywatnych (DM), żądań logowania, żądań statystyk itd. (nawet w sieci mesh, w której zablokowano ruch flood bez zakresu).
...
## Administracja przemiennikiem i room serwerem
...
Od wersji v1.15.0 obowiązuje nowa zasada dla _odpowiedzi_. Powstają one na przemienniku/room serwerze, ale rządzą się taką zasadą:
...
Na razie jest to _bezpieczniejsza_ opcja, zamiast domyślnego ustawiania odpowiedzi na domyślny zakres. W tym okresie przejściowym jest zbyt wiele sposobów, na które administrator przemiennika mógłby strzelić sobie w stopę i zablokować się poza własnym przemiennikiem!
...
## FAQ
**Pytanie: Jako administrator przemiennika, na co powinienem ustawić domyślny zakres?**
