...
- Wyłączanie zasilania repeatera przy długim przytrzymaniu przycisku ([#2883](https://github.com/meshcore-dev/MeshCore/pull/2883))
...
- Poprawka budowania repeatera Xiao nRF52 ([#2990](https://github.com/meshcore-dev/MeshCore/pull/2990))
