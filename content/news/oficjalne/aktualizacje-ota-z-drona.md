...
description: Recrof pokazuje, jak zaktualizować firmware trudno dostępnych repeaterów opartych o nRF52 za pomocą drona i niewielkiego modułu Xiao nRF52840.
...
# OTA z drona - firmware trudno dostępnych repeaterów
_Aktualizacja OTA trudno dostępnych repeaterów opartych o nRF52 za pomocą drona_

W miarę jak dodawaliśmy coraz więcej repeaterów do naszej lokalnej sieci mesh na Słowacji, odkryliśmy, że nie zawsze da się fizycznie dotrzeć do niektórych lokalizacji repeaterów wystarczająco często.
...
![Aktualizacja lokalnego repeatera z uConsole, adapterem BLE dużej mocy i anteną kierunkową](https://blog.meshcore.io/assets/images/2026/06/22/nrf_dfu_py.jpg)
...
Upewnij się, że repeater, który chcesz zaktualizować, używa [bootloadera OTAFIX autorstwa oltaco](https://github.com/oltaco/Adafruit_nRF52_Bootloader_OTAFIX/releases/) w wersji co najmniej 2.1 lub nowszej.
...
9. Ustaw `ble_name` na nazwę OTA używaną przez Twój repeater, oto kilka przykładów:
   - `4631 | 3401` dla płytek opartych o RAK - obejmuje zarówno RAK4631, jak i RAK3401 1W
   - `SENSECAP | SCAP` dla Seeed SenseCap Solar P1
   - `XIAO` dla repeatera opartego o XIAO NRF52 (tak, możesz zaktualizować Xiao swoim Xiao!)
...
11. [Pobierz](https://flasher.meshcore.io/) i skopiuj plik **zip** z firmware, który chcesz wgrać na swój repeater
...
13. Przymocuj Xiao do drona, wyślij komendę `start ota` do swojego repeatera i upewnij się, że Xiao mruga na niebiesko - to oznacza, że jest gotowy do flashowania Twojego repeatera
...
15. Regularnie pinguj swój repeater przez LoRa - poinformuje Cię, czy proces się rozpoczął, a po kilku minutach zacznie znów być osiągalny
...
Daj nam znać, czy ten poradnik pomógł Ci zaktualizować odległe repeatery! Śmiało zadawaj pytania w komentarzach albo na naszym [Discordzie](https://discord.com/channels/1495203904898728149/1509594396482601121).
